...
$usuarioID = $_SESSION['UsuarioID']; // Para uma variável
$usuarioNome = $_SESSION['UsuarioNome']; // Para uma variável
...
<nav class="navbar sticky-top">
    <div class="container-fluid d-flex justify-content-between">
        <!-- Botão para alternar a exibição da sidebar, alinhado à esquerda -->
        <button id="toggleSidebar" class="btn btn-link">
            <i class="fas fa-bars"></i> <!-- Ícone de menu -->
        </button>

        <!-- Alinhar o dropdown e o toggle do tema à direita -->
        <ul class="nav ml-auto">
            ...
            <!-- Botão para alternar entre lista e card -->
            <li class="nav-item">
                <a href="#" id="viewToggle" class="nav-link">
                    <i class="fas fa-th-list" title="Card/Lista"></i> <!-- Ícone inicial de lista -->
                </a>
            </li>
...
<div class="d-flex">
    ...
    <div id="sidebar-wrapper" class="sidebar">
        <div class="list-group list-group-flush">
            <!-- Botão Home 
            <button class="btn btn-secondary list-group-item list-group-item-action mb-2" id="btnHome">
            ...
            <!--button class="btn btn-secondary list-group-item list-group-item-action" onclick="listar_enderecosCompartilhados()">
                <i class="fa fa-share-alt"></i> Compartilhamentos
            </button-->
            
            <!-- Botão Leituras -->
            <!--
            <button class="btn btn-secondary list-group-item list-group-item-action mb-2" 
                    id="btnLeituras">
                <i class="fas fa-book"></i> Leituras manuais
            </button>
            -->
            <!-- Seção de Status MQTT -->
            <!--div class="mqtt-status-section">
                <h8>Status MQTT</h8>
                <div id="mqttStatus" class="status-indicator disconnected">Desconectado</div>
            </div-->
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div id="conteudoPrincipal" class="row">
            <!-- Sub-container: Endereços -->
            <div id="containerEnderecos" class="col-12 mb-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4>Locais</h4>
                    <div>
                        <button class="btn btn-primary" onclick="abrirModalEndereco()">Adicionar local</button>
                    </div>
                </div>
                <table class="table table-hover table-striped" id="tabelaEnderecos">
                    <thead>
                        <tr>
                            <th>Nome</th>
                            <th>Logradouro</th>
                    ...
                    <tbody id="listaenderecostab">
                        <tr>
                            <td colspan="4" style="text-align: center;">Carregando locais...</td>
                        </tr>
                    </tbody>
                </table>
                <div class="row g-2" id="listaenderecoscard" style="display: none;">
                    <!-- Cards de endereços serão inseridos aqui -->
                </div>
            </div>

            <!-- Sub-container: Piscinas -->
            <div id="containerPiscinas" class="col-12 mb-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <!-- Título dinâmico com suporte para o nome do endereço -->
                    <h4 id="containerPiscinasTitle">Piscinas <span id="nomeEnderecoPiscinas"></span></h4>
                    <div>
                        <button class="btn btn-primary" onclick="abrirModalPiscina()">Adicionar Piscina</button>
                    </div>
                </div>
                <!-- Tabela de piscinas -->
                <table class="table table-hover table-striped" id="tabelaPiscinas">
                    <thead>
                        <!-- Cabeçalhos serão gerados dinamicamente pelo JavaScript -->
                    </thead>
                    <tbody id="listapiscinastab">
                        <tr>
                            <td colspan="10" style="text-align: center;">Carregando piscinas...</td>
                        </tr>
                    </tbody>
                </table>
                <!-- Cards de piscinas -->
                <div class="row g-2" id="listapiscinascard" style="display: none;">
                    <!-- Os cards das piscinas serão inseridos dinamicamente aqui -->
                </div>
            </div>

            <!-- Sub-container: Dispositivos -->
            <div id="containerDispositivos" class="col-12 mb-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <!-- Título do container -->
                    <h4 id="containerDispositivosTitle">Dispositivos</h4>
                    <div>
                        <button class="btn btn-primary" onclick="abrirModalDispositivo()">Adicionar Dispositivo</button>
                    </div>
                </div>
                <!-- Tabela de dispositivos (exibição em modo "lista") -->
                <table class="table table-hover table-striped" id="tabelaDispositivos">
                    <thead>
                        <tr>
                            <th>Nome</th>
                            <th>MAC</th>
                    ...
                    <tbody id="listadispositivostab">
                        <tr>
                            <td colspan="8" style="text-align: center;">Carregando dispositivos...</td>
                        </tr>
                    </tbody>
                </table>
                <!-- Cards de dispositivos (exibição em modo "card") -->
                <div class="row g-2" id="listadispositivoscard" style="display: none;">
                    <!-- Cada card, além dos dados atuais, incluirá um botão "Exibir Entradas Digitais"
                        que, ao ser clicado, expande uma área com os parâmetros (nome e status) das 8 entradas digitais -->
                </div>
            </div>

            <!-- Container Principal de Leituras Manuais -->
            <div id="containerLeiturasManuais" class="col-12 mb-4" style="display: none;">
                ...
                <!-- Seções de Leituras por Piscina -->
